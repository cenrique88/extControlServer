...
app.get('/', async (req, res) => {
  try {
    res.send('<img src="https://www.rospratechgroup.com/assets/img/portfolio/api.gif" alt="API GIF" style="width: 100%; height: auto;"><h3 style="position: fixed; top: 10%, left: 10%">API en Funcionamiento</h3>');
  } catch (error) {
